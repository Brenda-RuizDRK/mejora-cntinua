...
export default function GuestLayout({ children }) {
    return (
        <div className="min-h-screen flex flex-col sm:flex-row bg-gradient-to-br from-[#ffda07] to-[#5096cf]">
            ...
            <div className="flex flex-col justify-center items-center w-full sm:w-1/2 text-white px-6 sm:px-12 py-12 ">
                ...
                <div className="w-full max-w-md bg-slate-500/20 backdrop-blur-md p-8 rounded-2xl shadow-lg">
